...
public class BandComm {
    ...
    public static final UUID tileId = UUID.nameUUIDFromBytes("Logue-tile".getBytes());//fromString("cc0D508F-70A3-47D4-BBA3-812BADB1F8Aa");
    public static final UUID pageId = UUID.nameUUIDFromBytes("Logue-page".getBytes());//UUID.fromString("b1234567-89ab-cdef-0123-456789abcd00");
